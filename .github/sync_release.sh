...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Arkanoid_MISTer.git"
CORE_NAME=(Arcade-Arkanoid)
...
UPSTREAM_CORE_NAME=(Arcade-Arkanoid)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-Arkanoid.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Arkanoid.rbf)
